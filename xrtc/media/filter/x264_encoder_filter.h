...
private:
    std::unique_ptr<InPin> in_pin_;//接受采集数据的输入
    std::unique_ptr<OutPin> out_pin_;//输出编码后的数据
    ...
    X264EncoderParam encoder_param_;//我们自己的编码参数
    x264_param_t* x264_param_ = nullptr;//x264的编码参数
